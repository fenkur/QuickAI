  ...
  return (
    ...
    text-slate-700'>
      ...
      border-gray-200'>
        ...
        accept='image/*' className='w-full p-2 px-3 mt-2 outline-none text-sm
        ...
        rounded-md border border-gray-300' placeholder='e.g., car in background, tree from image, watch, spoon, only single object name' required></textarea>
