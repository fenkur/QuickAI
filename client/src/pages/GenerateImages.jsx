  ...
  return (
    ...
    text-slate-700'>
      ...
      border-gray-200'>
        ...
        rounded-md border border-gray-300' placeholder='Describe what you want to see in the image..' required></textarea>

        <p className='mt-4 text-sm font-medium'>Style</p>

        <div className='mt-3 flex gap-3 flex-wrap'>
          {ImageStyle.map((item) => (
            <span onClick={() => setSelectedImageStyle(item)} 
            className={`text-xs px-4 py-1 border rounded-full cursor-pointer 
              ${selectedImageStyle === item ? 'bg-green-50 text-green-700'
        ...
        bg-gradient-to-r from-[#04FF50] to-[#00AD25] text-white px-4 py-2 mt-6
          ...
          !content ? (
            <div className='flex-1 flex justify-center items-center'>
              ...
              text-gray-400'>
                ...
                <p>Select an image style and click "Generate Image" to get started</p>
              </div>
            </div>
          ) : (
