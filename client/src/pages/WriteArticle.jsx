  ...
  return (
    ...
    text-slate-700'>
      ...
      border-gray-200'>
        ...
        rounded-md border border-gray-300' placeholder='The future of artificial intelligence is...' required></input>
        ...
        bg-gradient-to-r from-[#227BFF] to-[#65ADFF] text-white px-4 py-2 mt-6
